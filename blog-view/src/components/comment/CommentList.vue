<template>
    <div>
        <!-- 评论表单 -->
        <CommentForm v-show="parentCommentId === -1"></CommentForm>
        <div class="ui teal segment">
            <h3 class="ui dividing header">Comments|共有{{allComment}}条评论</h3>
            ...
            <div class="comment" v-for="comment in commentList" :key="comment.id">
                ...
                <div class="content">
                    <!-- 昵称 -->
                    <a class="nickname" :href="comment.website!=''&&comment.website!=null?comment.website:null" target="_blank" rel="external nofollow noopener">
                        {{ comment.nickname }}
                    </a>
                    <!-- 博主标识 -->
                ...
                <!-- 该条评论的回复列表 -->
                <div class="comments" v-if="comment.replyCommentList.length>0">
                    <div class="comment" v-for="reply in comment.replyCommentList" :key="reply.id">
                        ...
                        <div class="content">
                            ...
                            <div class="text">
                                <a :href="`#comment-${reply.parentCommentId}`">@{{ comment.nickname }}</a>
            ...
            <el-pagination style="text-align:center"
                background layout="prev, pager, next" :page-count="commentTotalPage" hide-on-single-page>
            </el-pagination>
        </div>
    </div>
</template>
            ...
            commentList:[
                {
                    id:1,
                    nickname:'张三',
                    avatar:'https://imgwarehouse.oss-cn-shanghai.aliyuncs.com/zhnblog/comment/avatar04.jpg',
                    createTime:'2022-11-17 19:00',
                    content:'666',
                    website:null,
                    adminComment:false,
                    parentCommentId:-1,
                ...
                },
                {
                    id:2,
                    nickname:'李四',
                    avatar:'https://imgwarehouse.oss-cn-shanghai.aliyuncs.com/zhnblog/comment/avatar03.jpg',
                    createTime:'2022-11-17 20:00',
                    content:'博客写的不错',
                    website:null,
                    adminComment:false,
                    parentCommentId:-1,
                    replyCommentList:[
                        ...
                        },
                        {
                            id:4,
                            nickname:'赵六',
                            avatar:'https://imgwarehouse.oss-cn-shanghai.aliyuncs.com/zhnblog/comment/avatar05.jpg',
                            createTime:'2022-11-17 22:00',
                            content:'确实',
                            website:'https://zhnblog.icu',
                            adminComment:false,
                            parentCommentId:2,
                            replyCommentList:[]
                        },
                ...
                },
                {
                    id:5,
                    nickname:'三七',
                    avatar:'https://imgwarehouse.oss-cn-shanghai.aliyuncs.com/zhnblog/comment/avatar07.jpg',
                    createTime:'2022-11-17 12:00',
                    content:'666',
                    website:null,
                    adminComment:false,
                    parentCommentId:-1,
