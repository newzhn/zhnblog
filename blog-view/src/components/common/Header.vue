<template>
	<header ref="header">
		<div class="view">
			<img ref="imgbg1" src="https://fastly.jsdelivr.net/gh/newzhn/blog-resource/bg1.jpg" style="display: none;">
			<div class="bg1" style="background-image: url('https://fastly.jsdelivr.net/gh/newzhn/blog-resource/bg1.jpg');"></div>
			<div class="bg2" style="background-image: url('https://fastly.jsdelivr.net/gh/newzhn/blog-resource/bg2.jpg');"></div>
			<div class="bg3" style="background-image: url('https://fastly.jsdelivr.net/gh/newzhn/blog-resource/bg3.jpg');" v-show="loaded"></div>
		</div>
		<div class="text-malfunction" data-word="ZHN's Blog">
			<div class="line"></div>
		</div>
		<div class="wrapper">
