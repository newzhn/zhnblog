...
export default {
    ...
    data() {
        return {
            ...
            blogMap:{
                '2022年12月':[
                    {id:'001',day:'31日',title:'2022年总结'},
                ],
                '2022年09月':[
                    {id:'001',day:'01日',title:'Java集合源码详解'},
                    {id:'002',day:'04日',title:'KMP算法详解'},
                    {id:'003',day:'15日',title:'Vuex和VueRouter用法'},
                    {id:'004',day:'27日',title:'2022年总结'},
                ],
                '2022年08月':[
                    {id:'001',day:'02日',title:'SpringMVC笔记'},
                    {id:'002',day:'08日',title:'JavaSE笔记'},
                    {id:'003',day:'11日',title:'Spring笔记'},
                    {id:'004',day:'23日',title:'Mybatis笔记'},
                ],
            }
        }
    },
